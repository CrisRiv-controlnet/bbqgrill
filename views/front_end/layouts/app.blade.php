...
<link rel="shortcut icon"
    ...
    <link rel="shortcut icon" href="{{ asset((isset($theme_favicon) && !empty($theme_favicon)) ? $theme_favicon : 'themes/' . $currentTheme  . '/assets/images/favicon.png') }}">
...
<body @if (in_array(\Request::route()->getName(), ['landing_page'])) class="home-page"
      @elseif (\Request::route()->getName() == 'page.product') class="product-page"
      @elseif(in_array(\Request::route()->getName(), ['page.product-list'])) class="product-list"
     @elseif(in_array(\Request::route()->getName(), ['page.cart'])) class="cart-list"  @else @endif>
