                        ...
                        <form method="POST" action="{{ route('customer.login', $slug) }}" class="login-form">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email" class="form-control"
                                                placeholder="shop@company.com" required="" value="{{ old('email') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                            ...
                            <div class="form-container">
                                <div class="row align-items-center form-footer justify-content-end">
                                    <div
                                        class="col-lg-12  col-12 d-flex align-items-center justify-content-end mobile-direction-column">
                                        <a href="{{ route('customer.password.request', $slug) }}"
                            ...
                            <div class="form-container">
                                <div class="row align-items-center">
                                    <div class="col-sm-12 col-12 d-flex align-items-center justify-content-center">
                                        ...
                                        <a href="{{ route('customer.register', $slug) }}" class="btn register-btn"
                                            type="submit">
                                            {{ __('Register') }}
                                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="14"
                                                viewBox="0 0 35 14" fill="none">
