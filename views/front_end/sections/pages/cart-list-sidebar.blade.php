...
<div id="cart-body" class="mini-cart-has-item">
                ...
                <div class="mini-cart-item">
                    ...
                    <div class="mini-cart-details">
                        ...
                        <div class="qty-spinner">
                            ...
                            <input type="text" class="quantity 45_quatity" data-cke-saved-name="quantity"
                                name="quantity" value="{{ $item->qty }}" min="01"
                                id="cart_list_sidebar_quantity{{ $item->qty }}" data-id="463">
                        ...
                        <div class="pvarprice d-flex align-items-center justify-content-between">
                            ...
                            <a class="remove_item remove_item_from_cart" title="Remove item" href="#"
    ...
    <div class="mini-cart-footer mini-cart-footer1">
        @if (!empty($response->data->cart_total_product))
            ...
            <div class="u-save d-flex justify-end">
                {{ __('Tax') }}:
                {{ currency_format_with_sym($response->data->tax_price ?? 0, $store->id, $currentTheme) ?? SetNumberFormat($response->data->tax_price) }}
            </div>
            @php
            ...
            <div class="mini-cart-footer-total-row d-flex align-items-center justify-content-between">
                ...
                <div class="mini-total-price">
                    {{ currency_format_with_sym($final ?? 0, $store->id, $currentTheme) ?? SetNumberFormat($final) }}
                </div>
            </div>
