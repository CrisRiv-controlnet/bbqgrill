          ...
          <div class="mini-wish-item">
             ...
             <div class="mini-wish-details" style="color: black;">
                ...
                <div class="pvarprice d-flex align-items-center justify-content-between">
                   <div class="price">
                   <ins>{!! currency_format_with_sym(\App\Models\Product::ProductPrice($currentTheme, $slug, $item->product_id,$item->variant_id), $store->id, $currentTheme) !!}</ins><del>{{ currency_format_with_sym(($item->original_price ?? 0) , $store->id, $currentTheme) ?? SetNumberFormat($item->original_price) }}</del>
                   </div>
