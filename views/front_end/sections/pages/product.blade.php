                                                ...
                                                <div class="product-selectors">
                                                    <div class="size-select">
                                                        ...
                                                        <select
                                                            ...
                                                            style="display: none;" name="varint[{{ $attribute->name }}]">
                                                            @php
                                                                $optionValues = [];
                                                            @endphp
                    ...
                    <div class="pdp-right-column-inner">
                        <div class="product-description-right">
                            ...
                            @if (!empty($product->custom_field))
                                ...
                                @endforeach
                            @endif
                            @foreach ($product->reviewData()->take(1) as $review)
                                <div class="pdp-block">
                                    <h5>{{ __('Ratings:') }}</h5>
                                    <div class="testimonials-card">
                                        <div class="testimonial-top d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="customer-nam">
                                                <strong>{{ !empty($review->UserData) ? $review->UserData->first_name : '' }}</strong>
                                                {{ __('Client') }}</div>
                                        </div>
                        ...
                        <div class="queary-div">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-primary Question"
                                    @if (\Auth::check()) data-ajax-popup="true" @else data-ajax-popup="true" @endif
