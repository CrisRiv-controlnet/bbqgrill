<section class="home-banner-section" style="@if (isset($option) && $option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
    ...
    <div class="mian-banner-image">
        <img src="{{ get_file($section->slider->section->background_image->image ?? '', $currentTheme) }}"
            class="{{ ($section->slider->section->background_image->slug ?? '') . '_preview' }}" alt="Category">
    </div>
    <div class="container ">
                ...
                <div class="banner-slider">
                    ...
                    <div class="home-banner-content">
                        <div class="home-banner-content-inner">
                            <div class="new-labl"
                                id="{{ ($section->slider->section->button_second->slug ?? '') . '_' . $i }}_preview">
                            ...
                            {{-- <div class="discount-rate">
                                <div class="star-wrapper">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="95" height="95"
                                        ...
                                        <path
                                            d="M5.99382 31.1656C3.65481 16.4027 16.4026 3.65491 31.1655 5.99392L33.2609 6.32592C37.8504 7.05307 42.5523 6.30837 46.6925 4.19858L48.5828 3.23529C61.9003 -3.55122 77.9634 4.63334 80.3009 19.3965L80.6327 21.492C81.3594 26.0815 83.5206 30.3232 86.8065 33.6087L88.3068 35.1089C98.8765 45.6775 96.0563 63.4836 82.738 70.2687L80.8476 71.2318C76.7072 73.3411 73.341 76.7073 71.2317 80.8477L70.2686 82.7381C63.4835 96.0564 45.6774 98.8766 35.1088 88.3069L33.6086 86.8066C30.3231 83.5207 26.0815 81.3595 21.4919 80.6328L19.3964 80.301C4.63324 77.9635 -3.55133 61.9004 3.23519 48.5829L4.19848 46.6926C6.30826 42.5524 7.05297 37.8505 6.32582 33.261L5.99382 31.1656Z"
                                            fill="#173334" />
                                    </svg>
                                </div>
                                <p><b class="discount-percentage">-30%</b>OFF</p>
                            </div> --}}
                            <div class="desk-wrapper">
                                <p
                                        id="{{ ($section->slider->section->description->slug ?? '') . '_' . $i }}_preview">
                                        {!! $section->slider->section->description->text->{$i} ?? '' !!}</p>
                            </div>
                            <a href="{{ route('page.product-list', ['storeSlug' => $slug]) }}" class="btn btn-white" tabindex="0"   id="{{ ($section->slider->section->button_first->slug ?? '') . '_' . $i }}_preview">
                                <span class="first-icon"><svg width="11" height="11" viewBox="0 0 11 11"
                                    ...
                                    {{ $section->slider->section->button_first->text->{$i} ?? '' }} <svg xmlns="http://www.w3.org/2000/svg" width="4" height="6"
