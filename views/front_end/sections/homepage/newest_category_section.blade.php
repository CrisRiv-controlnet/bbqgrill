...
<section class="categories-new" style="@if($option->is_hide == 1) opacity: 0.5; @else opacity: 1; @endif"
                ...
                <div class="category-card second-look">
                    @if ($key == '0')
                        <div class="category-img">
                            <img src="{{ asset('themes/' . $currentTheme . '/assets/images/img-4.png') }}">
                        </div>
                    @else
                        <div class="category-img">
                            <img src="{{ asset('themes/' . $currentTheme . '/assets/images/img-5.png') }}">
                        ...
                        <div class="btn-wrapper">
                            <a href="{{ route('page.product-list',  ['storeSlug' => $slug, 'filter_product'=>'created-descending']) }}" class="btn" id="{{ $section->newest_category->section->button->slug ?? '' }}_preview">
                                <span class="first-icon"><svg width="11" height="11" viewBox="0 0 11 11"
                                    ...
                                    {!! $section->newest_category->section->button->text->{$key} ?? '' !!} <svg xmlns="http://www.w3.org/2000/svg" width="4"
